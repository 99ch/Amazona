...
class Ybc_themeconfig extends Module
{
    ...
    public function __construct()
    {
        ...
        $this->configs = array(
            ...
            'YBC_TC_FONT1_DATA' => array(
                ...
                'separator' => true,
                'data_type' => 'font',
                'default' => 'https://fonts.googleapis.com/css?family=Lato:300,400,700,900',
                'validate' => 'isString',
            ),
    ...
    protected function removeLegacyOverrides()
    {
        $legacyOverride = dirname(__FILE__).'/override/classes/controller/ProductListingFrontController.php';
        if (file_exists($legacyOverride)) {
            @unlink($legacyOverride);
        }
    }
    ...
    {
        if (!$this->shouldAssignListingAjaxVars()) {
            return;
        }

        $controller = $this->context->controller;

        if (!method_exists($controller, 'getTemplateVarUrls') || !isset($this->context->smarty)) {
            return;
        }
    ...
    protected function shouldAssignListingAjaxVars()
    {
        ...
        if (class_exists('ProductListingFrontController') && $controller instanceof ProductListingFrontController) {
            return true;
        }

        return class_exists('ProductListingFrontControllerCore') && $controller instanceof ProductListingFrontControllerCore;
    }
